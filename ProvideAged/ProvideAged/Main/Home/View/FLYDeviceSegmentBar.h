...
@class FLYDeviceSegmentBar;

NS_ASSUME_NONNULL_BEGIN

@protocol FLYDeviceSegmentBarDelegate <NSObject>
...
@interface FLYDeviceSegmentBar : UIView
...
/**
 代理
 */
@property (nonatomic, weak) id<FLYDeviceSegmentBarDelegate> delegate;
